...
{ path: '/customers', label: 'Customers', icon: 'List' },
{ path: '/calibration-orders', label: 'CalibrationOrders', icon: 'List' },
      ];
        ...
        return (
          <div className="flex h-screen">
            ...
            <aside className={`${open ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:static z-30 w-64 h-full bg-white border-r transition-transform`}>
              <div className="p-4 border-b font-bold text-lg">Calibration Lab Manager</div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              <header className="md:hidden flex items-center gap-3 p-3 border-b bg-white">
                ...
                <span className="font-semibold">Calibration Lab Manager</span>
              </header>
