...
from ..parsers.models import (
    ...
    Interface, Page, Role, Environment, Workflow, WorkflowStep,
)
...
# ── Workflows (Makefile / Taskfile.yml) ───────────────────────
...
def _scan_workflows(root: Path, spec: DoqlSpec) -> None:
