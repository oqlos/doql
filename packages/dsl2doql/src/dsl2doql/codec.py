...
from dsl2doql.grammar import parse_line, to_text
...
def encode_protobuf(line: str, *, default_file: str = "", correlation_id: str = "") -> bytes:
    from dsl2doql.pb_codec import encode_text_to_protobuf
...
def decode_protobuf(data: bytes) -> str:
    from dsl2doql.pb_codec import decode_protobuf_to_text
