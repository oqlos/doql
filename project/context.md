...
- **Languages**: python: 165, yml: 16, json: 16, yaml: 15, doql: 13
...
- **Calls**: getattr, getattr, getattr, getattr, doql.drift.detector.detect_drift, getattr, getattr, print
...
- **Calls**: None.resolve, getattr, getattr, print, DoctorReport, doql.cli.commands.doctor.checks._check_parse, doql.cli.commands.doctor.checks._check_env, doql.cli.commands.doctor.checks._check_files
...
### doql.lsp_server.symbols.document_symbols
- **Calls**: server.feature, ls.workspace.get_text_document, doql.lsp_server.utils._parse_doc, doql.lsp_server.utils._find_line_col, lsp.Range, _mkrange, symbols.append, _mkrange
...
- **Calls**: None.resolve, _tf_discover, doql.cli.commands.workspace.output._print, doql.cli.commands.workspace.output._print, doql.cli.commands.workspace.output._print, _tf_filter, _tf_fix, None.expanduser

### doql.lsp_server.definition.definition
- **Calls**: server.feature, ls.workspace.get_text_document, doql.lsp_server.utils._word_at, re.compile, pattern.search, None.count, None.find, lsp.Location
...
- **Calls**: None.resolve, doql.cli.commands.workspace.run._select_run_projects, doql.cli.commands.workspace.output._print, enumerate, doql.cli.commands.workspace.run._print_run_summary, doql.cli.commands.workspace.output._print, doql.cli.commands.workspace.run._print_dry_run_commands, doql.cli.commands.workspace.run._execute_single_project
...
### doql.cli.commands.workspace.list._cmd_list
- **Calls**: None.resolve, doql.cli.commands.workspace.discovery._discover_local, doql.cli.commands.workspace.discovery._filter_projects, doql.cli.commands.workspace.list._print_project_table, doql.cli.commands.workspace.output._print, root.exists, doql.cli.commands.workspace.output._print, doql.cli.commands.workspace.output._print

### doql.cli.commands.workspace.analyze._cmd_validate
- **Calls**: doql.cli.commands.workspace.analyze._cmd_analyze, None.resolve, _tf_discover, doql.cli.commands.workspace.output._print, _tf_validate, None.expanduser, len, doql.cli.commands.workspace.output._print
...
```
document_symbols [doql.lsp_server.symbols]
  └─ →> _parse_doc
  └─ →> _find_line_col
```
...
### doql.cli.commands.doctor.report.Check
- **Methods**: 0
...
### doql.cli.commands.workspace.discovery.DoqlProject
...
### playground.doql_build._collect_parse_errors
> Append parse-recovery errors to *diags*.
- **Output to**: diags.append, getattr, getattr, getattr, str

### playground.doql_build._validate
> Run validation and append issues to *diags*.
- **Output to**: _parser.validate, diags.append, getattr
...
### doql.cli.commands.workspace.analyze._cmd_validate
- **Output to**: doql.cli.commands.workspace.analyze._cmd_analyze, None.resolve, _tf_discover, doql.cli.commands.workspace.output._print, _tf_validate
...
### doql.cli.commands.doctor.checks._check_parse
...
- **Output to**: doql.parsers.css_utils._strip_comments, doql.parsers.css_tokenizer._tokenise_css, doql.parsers.css_parser._map_to_spec, doql.parsers.extractors.collect_env_refs, doql.parsers.css_transformers.variables._resolve_less_vars
...
- `doql.cli.commands.drift.cmd_drift` - 27 calls
...
- `doql.lsp_server.symbols.document_symbols` - 19 calls
...
- `doql.lsp_server.definition.definition` - 15 calls
...
- `doql.cli.build.cmd_build` - 13 calls
...
- `doql.lsp_server.completion.completion` - 12 calls
...
- `playground.doql_build.build` - 10 calls
