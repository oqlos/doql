...
interface Device {
  id: any; serial: any; model: any; manufacturer: any; device_type: any; station: any; purchase_date: any; warranty_until: any; photo: any; barcode: any; status: any; last_inspection: any; total_uses: any;
}

export default function DevicePage() {
  const [items, setItems] = React.useState<Device[]>([]);
  const [showForm, setShowForm] = React.useState(false);
  const [form, setForm] = React.useState<any>({ serial: '', model: '', manufacturer: '', device_type: '', station: '', purchase_date: '', warranty_until: '', photo: '', barcode: '', status: '', last_inspection: '', total_uses: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setForm({ serial: '', model: '', manufacturer: '', device_type: '', station: '', purchase_date: '', warranty_until: '', photo: '', barcode: '', status: '', last_inspection: '', total_uses: '' });
    setShowForm(false);
    load();
  };
