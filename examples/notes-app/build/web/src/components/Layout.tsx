...
{ path: '/notebooks', label: 'Notebooks', icon: 'List' },
{ path: '/notes', label: 'Notes', icon: 'List' },
{ path: '/tags', label: 'Tags', icon: 'List' },
      ];
        ...
        return (
          <div className="flex h-screen">
            ...
            <aside className={`${open ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:static z-30 w-64 h-full bg-white border-r transition-transform`}>
              <div className="p-4 border-b font-bold text-lg">Notes</div>
